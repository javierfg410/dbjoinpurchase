...
class DbJointPurchaseSaveModuleFrontController extends ModuleFrontController
{
    ...
    public function displayAjax()
    {
        ...
        $selected = PurchaseJointHandler::getJointsByProduct($id_product);
        ...
        elseif ($action = 'check') {
            ...
            echo json_encode([PurchaseJointHandler::setJoint(Tools::getValue('product'), Tools::getValue('value'), $checked)]);
        }
